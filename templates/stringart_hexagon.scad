...
/* [Hexagon Frame] */
// Outer point-to-point width of the frame (height is derived automatically).
...
// Flat-to-flat height is derived from the point-to-point width.
...
module raw_outer_profile() {
    // OpenSCAD's $fn=6 circle points on the X-axis — flat edge at top and bottom.
